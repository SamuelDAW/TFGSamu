...
try {
    ...
    $mail->Body = "Hola,<br><br>Utiliza el siguiente código de invitación para unirte a nuestro grupo: <strong>$invitationCode</strong><br><br>Saludos,<br>Binance Gastos";
