...
class Gasto {
    ...
    public function getTransactionsByGroup($groupId) {
        $query = "SELECT d.nombre AS deudor, a.nombre AS acreedor, t.cantidad FROM transacciones t
                  JOIN usuarios d ON t.id_deudor = d.id
                  JOIN usuarios a ON t.id_acreedor = a.id
